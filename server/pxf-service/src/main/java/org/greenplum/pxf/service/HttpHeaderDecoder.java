...
/**
 * Service that can decode the values of http headers for PXF client requests.
 */
@Component
public class HttpHeaderDecoder {
    ...
    /**
     * Determines whether the http headers are expected to be encoded based on presence of the special PXF http header.
     *
    ...
    /**
     * Flattens the list of header values, and decodes if needed and the header name is produced by PXF client APIs.
     *
