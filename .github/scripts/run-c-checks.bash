...
#
# The gpadmin half of the work lives in run-c-checks-gpadmin.bash as a
...
su gpadmin -c "bash '${script_dir}/run-c-checks-gpadmin.bash' '${PREFIX}' '${gpdemo_env}' '${PXF_SRC}'"
