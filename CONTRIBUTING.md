...
conduct](https://github.com/warehouse-pg/whpg-pxf/blob/main/CODE-OF-CONDUCT.md).
...
- Submit a pull request (PR).
    ...
    - The [PXF CI](.github/workflows/README.md) workflow runs automatically
      on every PR (unit tests, CLI tests, a compile check for the
      integration-test tree, and static docs checks) — please keep it green.
